...
type EntityResponseType = HttpResponse<INhaXuatBan>;
type EntityArrayResponseType = HttpResponse<INhaXuatBan[]>;

@Injectable({ providedIn: 'root' })
export class NhaXuatBanService {
    public resourceUrl = SERVER_API_URL + 'api/nha-xuat-bans';
    ...
    update(nhaXuatBan: INhaXuatBan): Observable<EntityResponseType> {
        return this.http.put<INhaXuatBan>(this.resourceUrl, nhaXuatBan, { observe: 'response' });
    }
