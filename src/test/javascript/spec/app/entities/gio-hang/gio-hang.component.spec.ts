...
import { GioHangComponent } from 'app/entities/gio-hang/gio-hang.component';
import { GioHangService } from 'app/entities/gio-hang/gio-hang.service';
import { GioHang } from 'app/shared/model/gio-hang.model';

describe('Component Tests', () => {
    describe('GioHang Management Component', () => {
        let comp: GioHangComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(GioHangComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.gioHangs[0]).toEqual(jasmine.objectContaining({ id: '123' }));
        });
