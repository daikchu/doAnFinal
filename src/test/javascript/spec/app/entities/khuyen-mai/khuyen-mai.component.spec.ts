...
import { KhuyenMaiComponent } from 'app/entities/khuyen-mai/khuyen-mai.component';
...
describe('Component Tests', () => {
    describe('KhuyenMai Management Component', () => {
        let comp: KhuyenMaiComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(KhuyenMaiComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.khuyenMais[0]).toEqual(jasmine.objectContaining({ id: '123' }));
        });
