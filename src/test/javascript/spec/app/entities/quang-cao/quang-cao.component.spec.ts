...
import { QuangCaoComponent } from 'app/entities/quang-cao/quang-cao.component';
...
describe('Component Tests', () => {
    describe('QuangCao Management Component', () => {
        let comp: QuangCaoComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(QuangCaoComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.quangCaos[0]).toEqual(jasmine.objectContaining({ id: '123' }));
        });
